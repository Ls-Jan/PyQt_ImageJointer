...
from XJ.Widgets.XJQ_PreviewMask.XJQ_SelectedPreviewMask import XJQ_SelectedPreviewMask
from XJ.Widgets.XJQ_PreviewMask.XJQ_InsertPreviewMask import XJQ_InsertPreviewMask
...
class XJQ_PictJointer(QWidget):
	...
	def Opt_RemoveSelectedPicts(self):
		...
		cmds=[]
		for wid in self.__mskSe.Get_SelectedWidgets():
			cmds.append(Move(wid,None,None,False))
		self.__stk.push(MultiCmds(*cmds))
		self.__mskSe.Opt_Clear()
